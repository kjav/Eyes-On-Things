...
function EYEBALL(e_radius, p_radius, border_width) {
  ...
  eye.style.height = e_radius.toString() + 'px';
  eye.style.backgroundColor = '#ffffff';

  pupil.style.borderRadius = '50%';
  pupil.style.width = p_radius.toString() + 'px';
  pupil.style.height = p_radius.toString() + 'px';
  pupil.style.marginLeft = '-' + ((p_radius / 2) | 0).toString() + 'px';
  pupil.style.marginTop = '-' + ((p_radius / 2) | 0).toString() + 'px';
  pupil.style.backgroundColor = '#000000';

  document.body.appendChild(eye);

  eye.style.position = 'absolute';
  eye.style.left = window.scrollX.toString() + 'px';;
  eye.style.top = window.scrollY.toString() + 'px';
